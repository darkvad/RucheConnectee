...
/*
Copy this file in src/secrets and enter your onwn values
*/
...
#define DEVICEADDRESS 0x00000000
static u4_t DEVADDR = DEVICEADDRESS; // <-- Change this address for every node!
